...
print(Fore.LIGHTBLUE_EX + "$~~$~~$~~$~~     --" + Fore.LIGHTRED_EX + " SN1ff4Cr4ckS " + Fore.LIGHTBLUE_EX + "--     ~~$~~$~~$~~$\n")
...
def Cracker():
    print(Fore.LIGHTYELLOW_EX + 'CR444CKKKK333333RRR 888~~~~~~~~~~~888~~~~~~~~888')
    time.sleep(0.4)
    limpieza()
    print(Fore.LIGHTGREEN_EX + 'CR444CKKKK333333RRR 888~~~~~~~~~~~888~~~~~~~~###')
    time.sleep(0.8)
    limpieza()
    print(Fore.LIGHTYELLOW_EX + 'CR444CKKKK333333RRR 888~~~~~~~~~~~###~~~~~~~~###')
    time.sleep(0.4)
    limpieza()
    print(Fore.LIGHTRED_EX + 'CR444CKKKK333333RRR 888~~~~~~~~~~~###~~~~~~~~TobbyIsDobby PWN!\n')
    time.sleep(0.8)
    ls()
    file_selected = input('\nSelect the file you want to crack\n>')
    tarea=1
    for i in tqdm(range(tarea)):
        num = ('1', '')
        yes_no =  input(Fore.LIGHTGREEN_EX + '[!]Do you want to crack with phonenumbers?\n>')
        if yes_no in num:
    ...
    for i in tqdm(range(tarea)):
        num = ('1', '')
        yes_no =  input(Fore.LIGHTGREEN_EX + '[!]Do you want to crack with 8 digits numbers?\n>')
        if yes_no in num:
            if platform.system() == 'Linux':
    ...
    for i in tqdm(range(tarea)):
        num = ('1', '')
        yes_no =  input(Fore.LIGHTGREEN_EX + '[!]Do you want to crack with 9 digits numbers?\n>')
        if yes_no in num:
            if platform.system() == 'Linux':
    ...
    for i in tqdm(range(tarea)):
        num = ('1', '')
        yes_no =  input(Fore.LIGHTGREEN_EX + '[!]Do you want to crack with 10 digits numbers?\n>')
        if yes_no in num:
            if platform.system() == 'Linux':
    ...
    for i in tqdm(range(tarea)):
        num = ('1', '')
        yes_no =  input(Fore.LIGHTGREEN_EX + '[!]Do you want to crack with 8 lower case letters?\n>')
        if yes_no in num:
            if platform.system() == 'Linux':
    ...
    for i in tqdm(range(tarea)):
        num = ('1', '')
        yes_no =  input(Fore.LIGHTGREEN_EX + '[!]Do you want to crack with mix format (letters, numbers and more)?\n>')
        if yes_no in num:
            if platform.system() == 'Linux':
    ...
    for i in tqdm(range(tarea)):
        num = ('1', '')
        yes_no =  input(Fore.LIGHTGREEN_EX + '[!]Do you want to crack with a wordlist?\n>')
        if yes_no in num:
...
num = ('1', '')
election = input(Fore.LIGHTRED_EX + '[#]What do you want to do? Crack[1] or Sniff[2]?\n>')
if election in num:
    Cracker()
    ...
    for i in tqdm(range(tarea)):
        ...
        print('\n')
        time.sleep(1.5)
select = input(Fore.GREEN +'\n[#]What type of sniff and crack you want to use?\n\n' + Fore.BLUE + '-Cracking Single Wifi(1)' + Fore.YELLOW + ' 0R ' + Fore.RED + '-Cracking Wifi at Scale (2)\n' + Fore.GREEN + '>')
vari = ('1','') 
if select in vari:
  while True:
